...
//
// Modified by Chris Siefert 7/16/00

// C compatible matrix: row-oriented, 0-based [i][j] and 1-based (i,j) indexing
//
// function (row) has been added.  It returns the vector that contains that row.
// function (col) has been added.  It returns the vector that contains that column.
// Also, support for multiplication by a scalar has been added.
// Support for Vector * Matrix acting as if the vector was a row vector is added.
