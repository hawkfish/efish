/*
	...
	Copyright:	Copyright © 1995-1996 Jim Luther
...
#define CallIterateFilterProc(userRoutine, cpbPtr, dirID, quitFlag, yourDataPtr) \
		(*(userRoutine))((cpbPtr), (dirID), (quitFlag), (yourDataPtr))
