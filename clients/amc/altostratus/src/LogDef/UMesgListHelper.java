/*
 * File: ./LOGDEF/UMESGLISTHELPER.JAVA
 * From: LOGDEF.IDL
...
package LogDef;
public class UMesgListHelper {
     // It is useless to have instances of this class
     private UMesgListHelper() { }
    ...
    public static void write(org.omg.CORBA.portable.OutputStream out, byte[][] that)  {
          {
              ...
              for (int __index = 0 ; __index < that.length ; __index += 1) {
                  ...
                  out.write_octet_array(that[__index], 0, that[__index].length);
              }
          }
    }
    public static byte[][] read(org.omg.CORBA.portable.InputStream in) {
          byte[][] that;
          {
              ...
              for (int __index = 0 ; __index < that.length ; __index += 1) {
                  ...
                  that[__index] = new byte[__length2];
                  in.read_octet_array(that[__index], 0, that[__index].length);
              }
          }
          return that;
    }
   ...
   synchronized public static org.omg.CORBA.TypeCode type() {
          if (_tc == null)
             _tc = org.omg.CORBA.ORB.init().create_alias_tc(id(), "UMesgList", org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_octet))));
      return _tc;
   }
   public static String id() {
       return "IDL:LogDef/UMesgList:1.0";
   }
}
